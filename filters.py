...
class AttributeFilter:
    ...
    def __init__(self, op, value):
        """Construct new `AttributeFilter` from binary predicate and reference.
...
class VelocityFilter(AttributeFilter):
    """Subclass to AttributeFilter for velocity."""
...
class DiameterFilter(AttributeFilter):
    """Subclass to AttributeFilter for diameter."""

    @classmethod
    def get(cls, approach):
        """Get diameter attribute rest from a close approach."""
        return approach.neo.diameter


class DateFilter(AttributeFilter):
    """Subclass to AttributeFilter for date."""

    @classmethod
    def get(cls, approach):
        """Get date attribute from a close approach."""
        return approach.time.date()


class HazardousFilter(AttributeFilter):
    """Subclass to AttributeFilter for hazardous."""

    @classmethod
    def get(cls, approach):
        """Get hazardous attribute from a close approach."""
...
def create_filters(
    ...
    that occurred on exactly that given date. Similarly, the
